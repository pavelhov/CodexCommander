...
import { inspectMacosRuntimeBundleProvenance, macosRuntimeBundlePath } from "./macos-update-provenance";
export { inspectMacosRuntimeBundleProvenance, macosRuntimeBundlePath } from "./macos-update-provenance";
