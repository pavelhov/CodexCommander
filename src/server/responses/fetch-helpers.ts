...
export function providerFetch(provider: CodexCommanderProviderConfig): typeof globalThis.fetch {
  return (provider as CodexCommanderProviderConfig & { fetch?: typeof globalThis.fetch }).fetch ?? globalThis.fetch;
}
