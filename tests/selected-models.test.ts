...
function cfg(providers: Record<string, Partial<CodexCommanderProviderConfig>>, disabledModels?: string[]): Pick<CodexCommanderConfig, "disabledModels" | "providers"> {
  const full: Record<string, CodexCommanderProviderConfig> = {};
