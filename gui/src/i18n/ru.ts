...
export const ru: Record<TKey, string> = {
  ...
  "models.modeOptionDesc_default": "Соблюдать исходную настройку совместной работы каждой модели.",
