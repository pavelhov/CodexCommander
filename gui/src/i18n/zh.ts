...
export const zh: Record<TKey, string> = {
  ...
  "sub.policy.saved": "运行策略已保存。协议和线程上限适用于新会话；指导和回退适用于之后生成的子任务。",
  ...
  "sub.policy.compatibilityV2": "兼容性按任务和父级路由评估：原生 ChatGPT 父级可能发送外部提供方无法读取的加密 V2 工作者任务（#92）。已知路由能力时，自动指导会筛掉不兼容候选；显式覆盖会安全失败。要获得可预测的跨提供方委派，请使用经典 v1。",
