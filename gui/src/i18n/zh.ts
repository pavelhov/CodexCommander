...
export const zh: Record<TKey, string> = {
  ...
  "dash.injectionHint": "选择 OpenCodex 在工作者指导中点名的模型。何时委派仍由 Codex 决定；同步原生默认值是单独的设置。",
  ...
  "dash.multiAgentGuidanceHint": "在 OpenCodex 指导中点名可用的名单模型。不强制委派，也不为每个子任务路由；v1 仅在 max 或 ultra 时显示指导。",
  ...
  "sub.featured": "活跃名单",
  "sub.orderHint": "此处显示的顺序决定 Codex 模型选择器顶部第 1–5 位，以及 {cmd} 的默认模型候选。",
  ...
  "sub.delegation.modelHint": "OpenCodex 在指导中首先点名的模型。活跃名单仍可用于显式覆盖。",
  ...
  "sub.policy.compatibilityV2Plaintext": "已启用实验性的跨提供方 V2。OpenCodex 会转换原生协作协议，因此该父级的所有 V2 工作者消息（包括发给原生工作者的消息）均为明文。保存后请启动新会话；未知协议仍会安全失败。",
  ...
  "nav.openMenu": "打开菜单",
  "nav.closeMenu": "关闭菜单",
  "integrations.subtitle": "将客户端应用连接到同一个 OpenCodex 代理、模型和提供商账户。",
  "clientApps.subtitle": "选择你的工作应用。OpenCodex 会在后台处理提供商和路由。",
  "clientApps.client.codex": "Codex App、CLI 与 SDK",
  "clientApps.client.claude": "Claude Code",
  "clientApps.yourClients": "你的客户端应用",
  "clientApps.modelsVisible": "OpenCodex 目录中有 {count} 个",
  "clientApps.modelsVisibleStale": "上次已知的 OpenCodex 目录中有 {count} 个",
  ...
  "clientApps.flow.proxy": "OpenCodex 代理",
  ...
  "clientApps.check.proxy": "OpenCodex 代理可访问",
  "clientApps.check.models": "至少有一个模型可见",
  "clientApps.detail.config": "配置",
  "clientApps.detail.models": "OpenCodex 目录",
  "clientApps.detail.routing": "路由",
  "clientApps.detail.routingValue": "使用 OpenCodex 路由",
  ...
  "clientApps.apiAccess.body": "这些密钥用于客户端向 OpenCodex 认证；提供商凭据仍在“提供商”中管理。",
  ...
  "pws.reference.intro": "OpenCode Go 不提供实时剩余额度 API。这里将公开上限与通过此 OpenCodex 代理观测到的流量并列显示。",
  ...
  "pws.reference.spendObserved": "通过 OpenCodex 观测到 {amount}",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "integrations.opencodeDescription": "在 OpenCode 桌面应用中使用通过 OpenCodex 路由的所有模型。",
  ...
  "integrations.cliInstalledHint": "已安装 OpenCode CLI。一键启动需要 OpenCode Desktop；CLI 请在终端中运行 ocx opencode。",
  ...
  "integrations.modelsManaged": "从可见的 OpenCodex 模型目录同步",
  ...
  "integrations.securityTitle": "凭据仍由 OpenCodex 管理",
  "integrations.securityBody": "OpenCode 只会收到受保护的文件引用。OpenCodex 不会把提供商密钥迁移到钥匙串、复制订阅登录或修改 OpenCode 的认证存储。",
  ...
  "integrations.openedSuccess": "已打开 OpenCode，OpenCodex 连接已就绪。",
