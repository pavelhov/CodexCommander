...
export const ko: Record<TKey, string> = {
  ...
  "prov.loginOk": "{provider}에 로그인했습니다. Codex 모델 목록을 새로고침하려면 {section}에서 “{action}”을 선택하세요.",
  ...
  "prov.added": "“{name}”을(를) 추가했습니다. Codex 모델 목록을 새로고침하려면 {section}에서 “{action}”을 선택하세요.",
