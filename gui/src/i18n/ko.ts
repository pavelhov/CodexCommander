...
export const ko: Record<TKey, string> = {
  ...
  "dash.injectionHint": "OpenCodex가 워커 안내에서 이름을 지정할 모델을 고릅니다. 위임할 시점은 Codex가 정하며 네이티브 기본값 동기화는 별도입니다.",
  ...
  "dash.multiAgentGuidanceHint": "사용 가능한 로스터 모델을 OpenCodex 안내에 이름으로 넣습니다. 위임이나 모든 하위 작업의 라우팅을 강제하지 않으며, v1에서는 max 또는 ultra일 때만 안내합니다.",
  ...
  "sub.featured": "활성 로스터",
  "sub.orderHint": "여기 표시된 순서가 Codex 모델 피커 최상단 1~5위와 {cmd}의 기본 모델 후보를 결정합니다.",
  ...
  "sub.delegation.modelHint": "OpenCodex가 안내에서 가장 먼저 지정하는 모델입니다. 로스터는 명시적 오버라이드에도 사용할 수 있습니다.",
  ...
  "sub.policy.compatibilityV2Plaintext": "실험적 다중 프로바이더 V2가 활성화되었습니다. OpenCodex가 네이티브 협업 와이어를 변환하므로 네이티브 워커를 포함해 이 부모의 모든 V2 워커 메시지가 평문이 됩니다. 저장 후 새 세션을 시작하세요. 알 수 없는 스키마는 계속 안전하게 실패합니다.",
  ...
  "sub.workspace.notFeatured": "로스터에 없음",
  "sub.workspace.priority": "우선순위",
  "sub.workspace.removeFromFeatured": "{m}을(를) 활성 로스터에서 제거",
  "sub.workspace.selectModel": "모델 선택",
  "sub.workspace.selectModelDesc": "목록에서 모델을 선택하여 세부 정보를 확인하고 spawn_agent용 로스터에 추가하세요.",
  ...
  "nav.openMenu": "메뉴 열기",
  "nav.closeMenu": "메뉴 닫기",
  "integrations.subtitle": "클라이언트 앱을 동일한 OpenCodex 프록시, 모델 및 제공자 계정에 연결합니다.",
  "clientApps.subtitle": "작업할 앱을 선택하세요. 공급자와 라우팅은 OpenCodex가 뒤에서 처리합니다.",
  "clientApps.client.codex": "Codex App, CLI 및 SDK",
  "clientApps.client.claude": "Claude Code",
  "clientApps.yourClients": "내 클라이언트 앱",
  "clientApps.modelsVisible": "OpenCodex 카탈로그에 {count}개",
  "clientApps.modelsVisibleStale": "마지막 확인 OpenCodex 카탈로그에 {count}개",
  ...
  "clientApps.check.proxy": "OpenCodex 프록시에 연결 가능",
  "clientApps.check.models": "하나 이상의 모델이 표시됨",
  "clientApps.detail.config": "구성",
  "clientApps.detail.models": "OpenCodex 카탈로그",
  "clientApps.detail.routing": "라우팅",
  "clientApps.detail.routingValue": "OpenCodex 라우팅 사용",
  ...
  "clientApps.apiAccess.body": "이 키는 클라이언트를 OpenCodex에 인증합니다. 공급자 자격 증명은 공급자에서 관리합니다.",
  ...
  "pws.reference.intro": "OpenCode Go는 실시간 잔여 한도 API를 제공하지 않습니다. 공개된 한도와 이 OpenCodex 프록시를 통해 관측된 트래픽을 함께 표시합니다.",
  ...
  "pws.reference.spendObserved": "OpenCodex에서 {amount} 관측",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "integrations.opencodeDescription": "OpenCodex로 라우팅되는 모든 모델을 OpenCode 데스크톱 앱에서 사용합니다.",
  ...
  "integrations.cliInstalledHint": "OpenCode CLI가 설치되어 있습니다. 원클릭 실행에는 OpenCode Desktop이 필요합니다. CLI는 터미널에서 ocx opencode를 사용하세요.",
  ...
  "integrations.modelsManaged": "표시 중인 OpenCodex 카탈로그에서 동기화",
  ...
  "integrations.securityTitle": "자격 증명은 OpenCodex가 계속 관리합니다",
  "integrations.securityBody": "OpenCode에는 보호된 파일 참조만 전달됩니다. OpenCodex는 제공자 키를 키체인으로 옮기거나 구독 로그인을 복제하거나 OpenCode 인증 저장소를 수정하지 않습니다.",
  ...
  "integrations.openedSuccess": "OpenCodex 연결이 준비된 상태로 OpenCode를 열었습니다.",
