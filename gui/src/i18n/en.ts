...
export const en = {
  ...
  "models.newSessionsOnly": "New sessions only",
  "models.modeLabel_v1": "Classic v1",
  "models.modeLabel_default": "Follow Codex defaults",
  ...
  "models.catalogBehaviorHint": "Hidden models leave the catalog and picker but remain callable by exact ID. Changes take effect on the next Codex turn; no restart is needed.",
  ...
  "sub.saved": "Saved {n} quick picks. Start a new Codex session or run {cmd} to refresh existing sessions.",
  "sub.savedExcluded": "Saved {n} quick picks, but {missing} are not currently advertised to V2 workers.",
  "sub.savedRefreshFailed": "Saved {n} quick picks to disk, but the running catalog did not refresh cleanly. Run {cmd} before relying on the new order.",
  ...
  "sub.policy.messageDeliveryHint_plaintext": "Experimental. Enables mixed-provider V2; every V2 worker message from this parent is plaintext. Start a new session after changing it.",
  ...
  "sub.policy.concurrencyHint": "V2 counts total threads including the root; V1 counts child threads. Blank restores the Codex default. Applies to new sessions.",
  ...
  "sub.policy.saved": "Run policy saved. Protocol and thread-limit changes apply to new sessions; V2 delivery changes affect subsequent requests, so start a new session; guidance and fallback apply to future spawned turns.",
  ...
  "sub.policy.compatibilityV2": "Native encrypted V2 tasks cannot be read by external providers (#92). Automatic guidance filters known-incompatible workers and exact overrides fail closed. Choose Plaintext compatibility for mixed-provider V2, or Classic v1 for the established cross-provider path.",
  "sub.policy.compatibilityV2Plaintext": "Experimental mixed-provider V2 is enabled. CodexCommander translates the native collaboration wire, so every V2 worker message from this parent—including messages to native workers—is plaintext. Start a new session after saving; unrecognized schemas still fail closed.",
  ...
  "sub.catalog.nextSession": "Applies next session",
  "sub.catalog.unknown": "Catalog status unknown",
  "sub.catalog.staleNotice": "Saved catalog differs from {n} running Codex session(s). Run {cmd} when you are ready to restart them and apply this roster.",
  "sub.catalog.notRunningNotice": "No running Codex session is using this catalog. Saved changes will apply when the next session starts.",
  "sub.roster.excludedNotice": "Saved roster models are not currently advertised to V2 spawn_agent ({n}): {models}. The catalog file is loaded, but this roster is not fully effective.",
