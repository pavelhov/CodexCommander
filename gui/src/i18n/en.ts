...
export const en = {
  ...
  "dash.cost30d": "Est. cost (30d)",
  "dash.cost30dHint": "API list-price equivalent — never billed spend.",
  "dash.cost30dCoverage": "{priced} priced · {unpriced} unpriced · {unmetered} unmetered requests",
  "dash.planQuota.title": "Plan & quota",
  "dash.planQuota.hint": "Provider-reported limits and estimates — never billed spend.",
  "dash.planQuota.loading": "Loading provider quota…",
  "dash.planQuota.empty": "No provider quota data yet.",
  ...
  "prov.keyRemoveFail": "Failed to remove API key",
  ...
  "models.modeOptionDesc_v2": "Use the newer concurrent workflow for every model.",
  ...
  "sub.delegation.modelHint": "The model CodexCommander names first when guiding delegated work. The configured roster remains available for explicit overrides.",
  ...
  "sub.policy.messageDeliveryHint_plaintext": "Experimental. Enables mixed-provider V2; V2 task-message delivery from this parent is plaintext. This delivery-only change does not require Apply.",
  "sub.policy.preferred": "Preferred guidance model",
  "sub.policy.noPreferred": "No preferred model",
  "sub.policy.fallback": "Global child fallback",
  "sub.policy.fallbackHint": "Tried when a child's requested model is unavailable; quota-limited models are skipped.",
  "sub.policy.noFallback": "No fallback",
  "sub.policy.concurrency": "Thread limit",
  "sub.policy.concurrencyHint": "V2 counts total threads including the root; V1 counts child threads. Blank restores the Codex default.",
  ...
  "sub.policy.saved": "Run policy saved.",
  ...
  "sub.policy.compatibilityV2": "V2 tasks are encrypted; external providers cannot read them. Use Plaintext compatibility for mixed-provider V2, or Reliable V1 for the established path.",
  "sub.policy.compatibilityV2Plaintext": "Experimental mixed-provider V2 is enabled. Task-message delivery from this parent is plaintext, including messages to native workers.",
  ...
  // usage page
  "usage.title": "Usage",
  "usage.subtitle": "Requests and tokens tracked by your proxy. A failed read is never shown as zero.",
  ...
  "pws.quota.unavailableTitle": "Quota unavailable",
  "pws.quota.signInRequired": "Sign in required",
  "pws.quota.loginNeedsRefresh": "Login needs refresh",
  "pws.quota.upstreamUnavailable": "Temporarily unavailable",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "sub.delegationSetup.loading": "Loading delegation setup…",
  "sub.delegationSetup.title": "Teach Codex to use this roster",
  "sub.delegationSetup.subtitle": "Install the current roster guidance for new Codex tasks.",
  "sub.delegationSetup.statusReady": "Ready",
  "sub.delegationSetup.statusInstalled": "Installed",
  "sub.delegationSetup.statusShadowed": "Installed, but AGENTS.override.md is active",
  "sub.delegationSetup.statusNotInstalled": "Not installed",
  "sub.delegationSetup.statusUpdate": "Update available",
  "sub.delegationSetup.statusPartial": "Needs repair",
  "sub.delegationSetup.statusConflict": "Conflict",
  "sub.delegationSetup.statusUnsafe": "Needs attention",
  "sub.delegationSetup.modeLegend": "Delegation mode",
  "sub.delegationSetup.mode.balanced": "Balanced",
  "sub.delegationSetup.mode.balancedDescription": "Use a balanced delegation approach.",
  "sub.delegationSetup.mode.orchestrator": "Orchestrator",
  "sub.delegationSetup.mode.orchestratorDescription": "Use an orchestrator-led delegation approach.",
  "sub.delegationSetup.liveRoster": "Uses the live roster; model IDs are not copied into this setup.",
  "sub.delegationSetup.skillArtifact": "Delegation skill",
  "sub.delegationSetup.agentsArtifact": "Codex instructions",
  "sub.delegationSetup.preview": "Preview",
  "sub.delegationSetup.install": "Install",
  "sub.delegationSetup.update": "Update",
  "sub.delegationSetup.repair": "Repair",
  "sub.delegationSetup.changeMode": "Change mode",
  "sub.delegationSetup.remove": "Remove",
  "sub.delegationSetup.removeTitle": "Remove delegation setup",
  "sub.delegationSetup.removeConfirm": "Remove the managed delegation setup?",
  "sub.delegationSetup.manual": "Installer unavailable? Show manual setup",
  "sub.delegationSetup.manualHint": "Copy the server-provided setup prompt for the selected mode.",
  "sub.delegationSetup.copy": "Copy setup",
  "sub.delegationSetup.copied": "Copied",
  "sub.delegationSetup.copyUnavailable": "Copy unavailable",
  "sub.delegationSetup.newTask": "Start a new Codex task to use this setup.",
  "sub.delegationSetup.working": "Working…",
  ...
  "dash.media.title": "Grok Imagine media",
  "dash.media.experimental": "Experimental. Image and video generation are separate opt-ins and affect only new turns.",
  "dash.media.source": "Media credential source",
  "dash.media.sourceChoose": "Choose a source",
  "dash.media.sourceOauth": "Grok Build subscription (OAuth)",
  "dash.media.sourceApiKey": "xAI API key",
  "dash.media.images": "Grok image generation",
  "dash.media.imagesHint": "Optional. Codex native image generation remains the default while this is off.",
  "dash.media.videos": "Grok video generation",
  "dash.media.videosHint": "Optional durable video jobs with local validated artifacts.",
  "dash.media.ready": "The selected media source is ready.",
  "dash.media.recoverOauth": "Reconnect the canonical xAI OAuth account before new media work can start.",
  "dash.media.recoverApiKey": "Add or select an xAI API key before new media work can start.",
  "dash.media.noFallback": "CodexCommander never falls back to the other source.",
  "dash.media.saved": "Media settings saved.",
  "dash.media.saveFailed": "Media settings were not saved. The controls were restored.",
  "dash.media.actionApplied": "Media action applied.",
  "dash.media.actionFailed": "Media action was refused or became stale. Refresh and try again.",
  "dash.media.probeStatus": "Capability probe — image: {image}; video: {video}",
  "dash.media.probe": "Run capability probe",
  "dash.media.probeConfirm": "Run exactly one fixed image and one one-second 1080p video probe? Billing attribution is unknown and an ambiguous submission may consume quota without a result.",
  "dash.media.recoveryUpgrade": "This journal was created by a newer version. Upgrade CodexCommander; it remains read-only.",
  "dash.media.recoveryManual": "Media recovery cannot safely change this journal. Check its owner and permissions, then restart CodexCommander.",
  "dash.media.recoveryBlocked": "Video recovery is blocked. A confirmed quarantine preserves artifacts and requires a restart before admission can resume.",
  "dash.media.recoveryAction": "Quarantine and reset",
  "dash.media.recoveryConfirm": "Quarantine the unreadable media journal, preserve artifacts, and keep video blocked until acknowledgement and restart?",
  "dash.media.recoveryAck": "Acknowledge fence",
  "dash.media.recoveryAckConfirm": "Acknowledge the unknown-work fence? Video remains blocked in this process and requires a restart.",
  "dash.media.jobs": "Recent media jobs",
  "dash.media.ack": "Acknowledge",
  "dash.media.ackConfirm": "Acknowledge that this submission outcome is unknown and release its admission hold?",
  "dash.media.open": "Open",
  "dash.media.openConfirm": "Open this validated local media artifact?",
  "dash.media.reveal": "Reveal",
  "dash.media.revealConfirm": "Reveal this validated local media artifact in the file manager?",
