...
export const en = {
  ...
  "sub.policy.saved": "Run policy saved. Protocol and thread-limit changes apply to new sessions; guidance and fallback apply to future spawned turns.",
  ...
  "sub.policy.compatibilityV2": "Compatibility is per task and parent route: native ChatGPT parents may send encrypted V2 worker tasks that external providers cannot read (#92). Automatic guidance filters when route capability is known; exact overrides fail closed. Use Classic v1 for predictable cross-provider delegation.",
