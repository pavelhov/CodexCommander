...
export const en = {
  ...
  "prov.loginOk": "Logged in to {provider}. To refresh its models in Codex, choose “{action}” in {section}.",
  ...
  "prov.added": "Added “{name}”. To refresh its models in Codex, choose “{action}” in {section}.",
