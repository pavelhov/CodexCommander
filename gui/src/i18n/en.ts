...
export const en = {
  ...
  "dash.injectionHint": "Choose the model OpenCodex names in worker guidance. Codex still decides when to delegate; native-default sync is separate.",
  ...
  "dash.multiAgentGuidanceHint": "Names eligible roster models in OpenCodex guidance. It does not force delegation or route every child. On v1, guidance appears only at max or ultra effort.",
  ...
  "sub.delegation.modelHint": "The model OpenCodex names first when guiding delegated work. The active roster remains available for explicit overrides.",
  ...
  "sub.policy.compatibilityV2Plaintext": "Experimental mixed-provider V2 is enabled. OpenCodex translates the native collaboration wire, so every V2 worker message from this parent—including messages to native workers—is plaintext. Start a new session after saving; unrecognized schemas still fail closed.",
  ...
  "pws.reference.intro": "OpenCode Go does not expose a live remaining-balance API. These published caps are shown beside traffic observed through this OpenCodex proxy.",
  ...
  "pws.reference.spendObserved": "{amount} observed through OpenCodex",
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "modal.localHint": "No API key is stored. OpenCodex connects to this local server; live model discovery and the model list can be managed in Provider settings.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "integrations.subtitle": "Connect client apps to the same OpenCodex proxy, models, and provider accounts.",
  "clientApps.subtitle": "Choose where you work. OpenCodex handles providers and routing behind the scenes.",
  "clientApps.client.codex": "Codex App, CLI & SDK",
  "clientApps.client.claude": "Claude Code",
  "clientApps.yourClients": "Your client apps",
  "clientApps.modelsVisible": "{count} in OpenCodex catalog",
  "clientApps.modelsVisibleStale": "{count} in last-known OpenCodex catalog",
  ...
  "clientApps.flow.proxy": "OpenCodex proxy",
  ...
  "clientApps.check.proxy": "OpenCodex proxy is reachable",
  "clientApps.check.models": "At least one model is visible",
  "clientApps.detail.config": "Configuration",
  "clientApps.detail.models": "OpenCodex catalog",
  "clientApps.detail.routing": "Routing",
  "clientApps.detail.routingValue": "Uses OpenCodex routing",
  ...
  "clientApps.apiAccess.body": "These keys authenticate clients to OpenCodex; provider credentials stay under Providers.",
  ...
  "integrations.opencodeDescription": "Use every model routed through OpenCodex inside the OpenCode desktop app.",
  ...
  "integrations.cliInstalledHint": "The OpenCode CLI is installed. One-click launch requires OpenCode Desktop; use ocx opencode in a terminal for the CLI.",
  "integrations.modifiedHint": "OpenCode's config changed after OpenCodex applied its provider. Restore will remove only the managed provider and preserve the other edits.",
  ...
  "integrations.modelsManaged": "Synced from the visible OpenCodex catalog",
  ...
  "integrations.securityTitle": "Your credentials stay owned by OpenCodex",
  "integrations.securityBody": "OpenCode receives a protected file reference. OpenCodex does not move provider keys to Keychain, duplicate subscription logins, or touch OpenCode's auth store.",
  ...
  "integrations.openedSuccess": "OpenCode opened with the OpenCodex connection ready.",
