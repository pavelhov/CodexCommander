...
export const ja: Record<TKey, string> = {
  ...
  "sub.policy.saved": "実行ポリシーを保存しました。プロトコルとスレッド上限は新しいセッションに、ガイダンスとフォールバックは今後の子タスクに適用されます。",
  ...
  "sub.policy.compatibilityV2": "互換性はタスクと親ルートごとに評価されます。ネイティブ ChatGPT の親は、外部プロバイダーが読めない暗号化 V2 ワーカータスクを送る場合があります (#92)。ルート能力が分かる場合、自動ガイダンスは候補を絞り、明示的なオーバーライドは安全に失敗します。予測可能なプロバイダー間委任には Classic v1 を使ってください。",
