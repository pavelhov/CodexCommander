...
export const ja: Record<TKey, string> = {
  ...
  "dash.injectionHint": "OpenCodex がワーカー向けガイダンスで示すモデルを選びます。委任するタイミングは Codex が決め、ネイティブ既定値の同期は別設定です。",
  ...
  "dash.multiAgentGuidanceHint": "利用可能なロースターモデルを OpenCodex のガイダンスで示します。委任や全子タスクのルーティングを強制しません。v1 では max または ultra のときだけ表示します。",
  ...
  "sub.delegation.modelHint": "OpenCodex がガイダンスで最初に示すモデルです。ロースターは明示的なオーバーライドにも使えます。",
  ...
  "sub.policy.compatibilityV2Plaintext": "実験的な複数プロバイダー V2 が有効です。OpenCodex がネイティブ連携ワイヤーを変換するため、この親からのすべての V2 ワーカーメッセージ（ネイティブ宛ても含む）は平文になります。保存後に新規セッションを開始してください。未知のスキーマは引き続き安全に失敗します。",
  ...
  "pws.reference.intro": "OpenCode Go は残量を取得するライブ API を公開していません。公開上限と、この OpenCodex プロキシを通過した通信の観測値を並べて表示します。",
  ...
  "pws.reference.spendObserved": "OpenCodex で {amount} を観測",
  ...
  "integrations.subtitle": "クライアントアプリを同じ OpenCodex プロキシ、モデル、プロバイダーアカウントに接続します。",
  "clientApps.subtitle": "作業するアプリを選びます。プロバイダーとルーティングは OpenCodex が背後で処理します。",
  "clientApps.client.codex": "Codex App、CLI、SDK",
  "clientApps.client.claude": "Claude Code",
  "clientApps.yourClients": "クライアントアプリ",
  "clientApps.modelsVisible": "OpenCodex カタログに {count} 件",
  "clientApps.modelsVisibleStale": "前回確認した OpenCodex カタログに {count} 件",
  ...
  "clientApps.check.proxy": "OpenCodex プロキシに接続可能",
  "clientApps.check.models": "少なくとも 1 つのモデルが表示可能",
  "clientApps.detail.config": "設定",
  "clientApps.detail.models": "OpenCodex カタログ",
  "clientApps.detail.routing": "ルーティング",
  "clientApps.detail.routingValue": "OpenCodex ルーティングを使用",
  ...
  "clientApps.apiAccess.body": "これらのキーはクライアントを OpenCodex に認証します。プロバイダー認証情報はプロバイダーで管理します。",
  ...
  "integrations.opencodeDescription": "OpenCodex 経由のすべてのモデルを OpenCode デスクトップアプリで利用します。",
  ...
  "integrations.cliInstalledHint": "OpenCode CLI はインストール済みです。ワンクリック起動には OpenCode Desktop が必要です。CLI はターミナルで ocx opencode を実行してください。",
  ...
  "integrations.modelsManaged": "表示中の OpenCodex カタログから同期",
  ...
  "integrations.securityTitle": "認証情報は OpenCodex が管理します",
  "integrations.securityBody": "OpenCode には保護されたファイル参照だけを渡します。OpenCodex はプロバイダーキーをキーチェーンへ移動せず、サブスクリプションログインを複製せず、OpenCode の認証ストアにも触れません。",
  ...
  "integrations.openedSuccess": "OpenCodex 接続を準備して OpenCode を開きました。",
