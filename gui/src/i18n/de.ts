...
export const de: Record<TKey, string> = {
  ...
  "dash.injectionHint": "Wähle das Modell, das OpenCodex in der Worker-Anleitung nennt. Codex entscheidet weiterhin, wann delegiert wird; die nativen Standardwerte sind separat.",
  ...
  "dash.multiAgentGuidanceHint": "Nennt geeignete Roster-Modelle in der OpenCodex-Anleitung. Erzwingt keine Delegierung und routet nicht jeden Kindlauf; v1 zeigt die Anleitung nur bei max oder ultra.",
  ...
  "sub.orderHint": "Die hier angezeigte Reihenfolge bestimmt die Plätze 1–5 oben in der Codex-Modellauswahl und die Standard-Modellkandidaten für {cmd}.",
  ...
  "sub.delegation.modelHint": "Das Modell, das OpenCodex in der Anleitung zuerst nennt. Der Roster bleibt für explizite Overrides verfügbar.",
  ...
  "sub.policy.compatibilityV2Plaintext": "Experimentelles V2 über mehrere Anbieter ist aktiviert. OpenCodex übersetzt das native Kollaborationsprotokoll; dadurch sind alle V2-Worker-Nachrichten dieses Elternagenten Klartext, auch an native Worker. Nach dem Speichern eine neue Sitzung starten; unbekannte Schemas schlagen weiter sicher fehl.",
  ...
  "sub.workspace.notFeatured": "Nicht im Kader",
  ...
  "sub.workspace.selectModelDesc": "Wähle ein Modell aus der Liste, um Details anzuzeigen und es für spawn_agent in den Kader aufzunehmen.",
  ...
  "integrations.subtitle": "Verbinde Client-Apps mit demselben OpenCodex-Proxy, seinen Modellen und Provider-Konten.",
  "clientApps.subtitle": "Wähle, wo du arbeitest. OpenCodex übernimmt Provider und Routing im Hintergrund.",
  "clientApps.client.codex": "Codex App, CLI & SDK",
  "clientApps.client.claude": "Claude Code",
  "clientApps.yourClients": "Deine Client-Apps",
  "clientApps.modelsVisible": "{count} im OpenCodex-Katalog",
  "clientApps.modelsVisibleStale": "{count} im zuletzt bekannten OpenCodex-Katalog",
  ...
  "clientApps.check.proxy": "Der OpenCodex-Proxy ist erreichbar",
  "clientApps.check.models": "Mindestens ein Modell ist sichtbar",
  "clientApps.detail.config": "Konfiguration",
  "clientApps.detail.models": "OpenCodex-Katalog",
  "clientApps.detail.routing": "Routing",
  "clientApps.detail.routingValue": "Verwendet OpenCodex-Routing",
  ...
  "clientApps.apiAccess.body": "Diese Schlüssel authentifizieren Clients bei OpenCodex; Provider-Zugangsdaten bleiben unter Provider.",
  ...
  "pws.reference.intro": "OpenCode Go bietet keine Live-API für das verbleibende Guthaben. Diese veröffentlichten Obergrenzen stehen neben dem Datenverkehr, den dieser OpenCodex-Proxy beobachtet hat.",
  ...
  "pws.reference.spendObserved": "{amount} über OpenCodex beobachtet",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "integrations.opencodeDescription": "Nutze jedes über OpenCodex geroutete Modell in der OpenCode-Desktop-App.",
  ...
  "integrations.cliInstalledHint": "Die OpenCode-CLI ist installiert. Der Ein-Klick-Start erfordert OpenCode Desktop; für die CLI verwende ocx opencode im Terminal.",
  ...
  "integrations.modelsManaged": "Mit dem sichtbaren OpenCodex-Katalog synchronisiert",
  ...
  "integrations.securityTitle": "Deine Anmeldedaten bleiben bei OpenCodex",
  "integrations.securityBody": "OpenCode erhält eine geschützte Dateireferenz. OpenCodex verschiebt keine Provider-Schlüssel in den Schlüsselbund, dupliziert keine Abo-Anmeldungen und verändert OpenCodes Auth-Speicher nicht.",
  ...
  "integrations.openedSuccess": "OpenCode wurde mit bereiter OpenCodex-Verbindung geöffnet.",
