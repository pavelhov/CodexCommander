...
export const de: Record<TKey, string> = {
  ...
  "sub.policy.saved": "Ausführungsrichtlinie gespeichert. Protokoll und Thread-Limit gelten für neue Sitzungen; Anleitung und Fallback für künftige Kindläufe.",
  ...
  "sub.policy.compatibilityV2": "Die Kompatibilität hängt von Aufgabe und Elternroute ab: Native ChatGPT-Eltern können verschlüsselte V2-Worker-Aufgaben senden, die externe Anbieter nicht lesen können (#92). Automatische Anleitung filtert bei bekannter Route; explizite Overrides schlagen sicher fehl. Für vorhersehbare anbieterübergreifende Delegierung Classic v1 nutzen.",
