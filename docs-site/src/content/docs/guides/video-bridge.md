...
tool, or web-search text. Requests for plural or counted video outputs (for example, “Produce two
videos”) are rejected for confirmation before any video submission; v1 does not split or queue them.
