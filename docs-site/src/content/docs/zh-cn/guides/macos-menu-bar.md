...
打开 [GitHub Releases](https://github.com/pavelhov/CodexCommander/releases)，下载当前同时支持 Intel Mac
和 Apple 芯片 Mac 的通用预览版。请选择 `CodexCommander-<version>-macos-universal.zip` 文件及其匹配的
`.sha256` 校验和文件。
