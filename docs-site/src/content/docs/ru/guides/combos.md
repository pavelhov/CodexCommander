...
4. Включить **Plaintext compatibility** в **Subagents → Run Policy**, затем начать новую сессию.
...
Откройте локальный дашборд и выберите **Combos**. Рабочая область умеет создавать, редактировать,
...
описаны в [справочнике Management API](/reference/management-api/).
