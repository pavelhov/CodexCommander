...
| **API Access** | Выпуск и управление ключами, которыми другие приложения аутентифицируются в прокси OpenCodex. Учётные данные вышестоящих провайдеров остаются в Providers. |
