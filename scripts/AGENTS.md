# Script and packaging-tooling instructions
...
- Never run a publish, version-bump, deployment, or signing command unless the task explicitly requires the action and `MAINTAINERS.md` permits it.
...
- Do not weaken dry-run, exact-commit, CI-success, or explicit-confirmation gates in any future publishing automation.
